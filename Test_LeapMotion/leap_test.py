    ...
    def on_frame(self, controller):
        ...
        for hand in frame.hands:
            ...
            if (handType == "Left hand"):
                ...
                # pointable = hand.pointables().frontmost();
                # directionp = pointable.direction()
                # print(directionp)
                ...
                armrol = int(arm.direction.roll * Leap.RAD_TO_DEG)
                ...
                # print("hand_y:" + str(hand_y) + "  left wrist_r: "+ str(wrist_roll) + 
                # "  y: "+ str(y), " x: "+ str(x) )

                time.sleep(0.1)
                #print(wrist_roll_r)
                # data = json.dumps({"x":wrist_pitch_r, "y":wrist_roll_r, "z":forearm_yaw_r, "a":strength, "b":armdir, "c":z, "d":x, "e":y})
                # s.send(data.encode())
